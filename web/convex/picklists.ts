...
const SCOPE = v.union(v.literal("covenants"), v.literal("checklist"), v.literal("collateral"), v.literal("conditions"), v.literal("policy-exceptions"), v.literal("fees"), v.literal("relationships"));
